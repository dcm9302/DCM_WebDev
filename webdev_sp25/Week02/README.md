...
2. Read [this article](http://mediatemple.net/blog/tips/five-important-considerations-for-wireframing/?utm_source=weekly_newsletter&utm_medium=email&utm_campaign=aug17newsletter) on wireframing. Post a brief reaction in a markdown file in your repo. Add a `.txt` or `.md` file to your `Week02` HW folder in your class repository.

3. Using the recipe you uploaded last week *(or a new one)* wireframe your desired layout for a single recipe page on your hypothetical recipe site. Try to style the navigation and subnavigation based on the recipe site you made a sitemap of. Think - rows, columns, sidebars, headers, footers etc. Be sure to mark up each block of content in your wireframe with a few HTML tags for practice.
